...
function CardStructureHome({ cardData, onLike, onDelete }) {
    const { title, description, email, web, imageSrc, alt, openingText, phone,
        addressLine1, addressLine2, city, state, zip, liked, creatorId, likesCount,
    } = cardData
    ...
    return (<div className="business-card containerCards">
        <div className="business-card-image-wrapper">
            {imageSrc ? (<img className="business-card-image"
        ...
        <div className="business-card-content">
            ...
            <div className="emailWeb">
                <div className="">  <a href={`mailto:${email}`} className="business-card-email">
                    <i className="bi bi-envelope-fill"></i> {email}
                </a> </div>
                {web && (<a href={web} target="_blank" rel="noopener noreferrer"
